...
Your Mark: 2 (members not recorded)
  ...
  - Sprint Planning meeting (sprintN.md) (max 2 marks)
    ...
    Your Mark: 1 (members not recorded) 
...
## User Stories (Tracked in JIRA) (max 10 marks) 
  ...
  - Clearly Defined Acceptance Criteria (max 2 marks)
    ...
    Your Mark: 1 (OBELISK-21 and OBELISK-27 have missing AC)
...
Your Mark: 0 (Missing ticket number in commits)
